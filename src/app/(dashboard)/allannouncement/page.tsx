...
const AnnouncementList = async ({
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0" style={{ background: "red" }}>
      {/* TOP SECTION */}
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold" style={{background:"red"}}>All Announcements</h1>
